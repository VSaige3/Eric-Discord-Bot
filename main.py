...
# }
# NOTE: PLEASE READ
# It would be very helpful if you could find a way to actually test this bot. I think by the end of next lesson I will require that you
# can run and test it, otherwise this project will be quite useless to you I think. Perhaps you can leave a server? Or you own your own server that
# you could run the bot in a private channel? Or you could create another account perhaps?
# Just try to please have a way of testing by next lesson
...
# don't worry about the output from get_results_from_roll for now
@bot.command()
async def roll(ctx):
    """
    Rolls the roulette table
    """
    roll = roll_roulette()
